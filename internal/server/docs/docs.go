...
const docTemplate = `{
        ...
        "schemas": {
            ...
            "api.ACLAddRequest": {
                "properties": {
                    "accounts": {
                        "items": {
                            "$ref": "#/components/schemas/api.ACLAddAccount"
                        },
                        "type": "array",
                        "uniqueItems": false
                    }
            ...
            "api.ACLChangePermissionsRequest": {
                "properties": {
                    "changes": {
                        "items": {
                            "$ref": "#/components/schemas/api.ACLPermissionChange"
                        },
                        "type": "array",
                        "uniqueItems": false
                    }
            ...
            "api.BlockCreateRequest": {
                "properties": {
                    "nav": {
                        "$ref": "#/components/schemas/api.BlockNav"
                    },
                    "style": {
                        "additionalProperties": {},
                        "type": "object"
            ...
            "api.ChatSendRequest": {
                "properties": {
                    "agent": {
                        "$ref": "#/components/schemas/api.ChatAgentMeta"
                    },
                    "attachments": {
                        "additionalProperties": {
            ...
            "api.DatasetDefResponse": {
                "properties": {
                    ...
                    "fields": {
                        "items": {
                            "$ref": "#/components/schemas/api.DatasetFieldDef"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
            ...
            "api.DatasetDraftRequest": {
                "properties": {
                    "deleteBy": {
                        "description": "DeleteBy: \"anyone\" (default) or \"author\" (requires a\nstamp:creator field among fields).",
                        "type": "string"
                    },
                    "description": {
                        "type": "string"
                    ...
                    "dynamic": {
                        "description": "Dynamic keeps a free-form keyspace next to the declared fields.",
                        "type": "boolean"
                    },
                    "fields": {
            ...
            "api.DatasetFieldDef": {
                "properties": {
                    ...
                    "id": {
                        "description": "Id is the field definition record's id — the identity\nPATCH / DELETE …/fields/:fieldId target.",
                        "type": "string"
                    },
                    "key": {
                        "type": "string"
                    ...
                    "shape": {
                        "$ref": "#/components/schemas/api.DatasetFieldShape"
                    },
                    "stamp": {
                        "type": "string"
                    },
            ...
            "api.DatasetFieldDraft": {
                "properties": {
                    ...
                    "key": {
                        "description": "Key is the on-record field name — pinned.",
                        "type": "string"
                    },
                    "kind": {
                        "description": "Kind is a PropertyKind* wire string. Required unless stamp\nimplies one (creator ⇒ string, createTime/modifyTime ⇒ datetime).",
                        "type": "string"
                    },
                    "mutableBy": {
                        "description": "MutableBy: \"never\" (default — write-once), \"author\", \"any\".\n\"author\" requires a stamp:creator field in the dataset.",
                        "type": "string"
                    },
                    "name": {
                        "type": "string"
                    ...
                    "required": {
                        "description": "Required: field must be present on create. Incompatible with stamp.",
                        "type": "boolean"
                    },
                    "scope": {
                        "description": "Scope: \"synced\" (default) or \"local\"; \"derived\" is implied by\nstamp and rejected otherwise.",
                        "type": "string"
                    },
                    "shape": {
                        "$ref": "#/components/schemas/api.DatasetFieldShape"
                    ...
                    "stamp": {
                        "description": "Stamp: \"creator\" | \"createTime\" | \"modifyTime\" — value derived at\napply time, client writes rejected.",
                        "type": "string"
                    },
                    "xFormat": {
                        "additionalProperties": {},
            ...
            "api.DatasetFieldShape": {
                "description": "Shape is the full declared value shape (kind plus items /\nproperties) when one was declared beyond the bare kind.",
                "properties": {
                    "items": {
                        "$ref": "#/components/schemas/api.DatasetFieldShape"
                    },
            ...
            "api.DatasetsResponse": {
                "properties": {
                    "datasets": {
                        "items": {
                            "$ref": "#/components/schemas/api.DatasetSchema"
                        },
                        "type": "array",
                        "uniqueItems": false
                    }
            ...
            "api.FileInfo": {
                "properties": {
                    "cached": {
                        "description": "Cached reports a complete local copy (always true for inline).",
                        "type": "boolean"
                    },
                    "durable": {
                        "description": "Durable reports a verified network-custody receipt (inline files\nare durable by construction). False right after attach is normal:\nbackup runs in the background — watch /files/subscribe or re-GET.",
                        "type": "boolean"
                    },
                    "fileId": {
                        "type": "string"
                    ...
                    "inline": {
                        "description": "Inline reports the inline tier (no rootCid, no backup needed).",
                        "type": "boolean"
                    },
                    "mime": {
                        "type": "string"
                    ...
                    "rootCid": {
                        "description": "RootCid is the content address of the encrypted file. Empty for\ninline-tier files (bytes ride the CRDT row itself).",
                        "type": "string"
                    },
                    "size": {
                        "description": "Size is the plaintext byte size.",
                        "type": "integer"
                    },
                    "variant": {
                        "type": "string"
            ...
            "api.FileStatus": {
                "properties": {
                    "attempts": {
                        "description": "Attempts counts failed background attempts since the last\nsuccess/enqueue; 0 when no work is pending.",
                        "type": "integer"
                    },
                    "cached": {
                        "type": "boolean"
            ...
            "api.HistoryChange": {
                "properties": {
                    ...
                    "touched": {
                        "items": {
                            "$ref": "#/components/schemas/api.HistoryTouchedRecord"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
            ...
            "api.HistoryDatasetDiff": {
                "properties": {
                    ...
                    "records": {
                        "items": {
                            "$ref": "#/components/schemas/api.HistoryRecordDiff"
                        },
                        "type": "array",
                        "uniqueItems": false
                    }
            ...
            "api.HistoryDiffResponse": {
                "properties": {
                    ...
                    "datasets": {
                        "items": {
                            "$ref": "#/components/schemas/api.HistoryDatasetDiff"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
            ...
            "api.HistoryListResponse": {
                "properties": {
                    "changes": {
                        "items": {
                            "$ref": "#/components/schemas/api.HistoryChange"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
            ...
            "api.HistoryRecordDiff": {
                "properties": {
                    "fields": {
                        "items": {
                            "$ref": "#/components/schemas/api.HistoryFieldDiff"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
            ...
            "api.HistoryViewResponse": {
                "properties": {
                    "datasets": {
                        "items": {
                            "$ref": "#/components/schemas/api.HistoryViewDataset"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
            ...
            "api.IdentitiesListResponse": {
                "properties": {
                    "identities": {
                        "items": {
                            "$ref": "#/components/schemas/api.IdentityInfo"
                        },
                        "type": "array",
                        "uniqueItems": false
                    }
            ...
            "api.InvitesListResponse": {
                "properties": {
                    "invites": {
                        "items": {
                            "$ref": "#/components/schemas/api.InviteInfo"
                        },
                        "type": "array",
                        "uniqueItems": false
                    }
            ...
            "api.JoinRequestsResponse": {
                "properties": {
                    "requests": {
                        "items": {
                            "$ref": "#/components/schemas/api.JoinRequest"
                        },
                        "type": "array",
                        "uniqueItems": false
                    }
            ...
            "api.LocalAggregateRequest": {
                "properties": {
                    ...
                    "coll": {
                        "$ref": "#/components/schemas/api.LocalCollection"
                    },
                    "explain": {
                        "type": "boolean"
                    },
            ...
            "api.LocalCollection": {
                "properties": {
                    "name": {
                        "description": "Name: ^[a-z0-9][a-z0-9_-]{0,63}$.",
                        "type": "string"
                    },
                    "scope": {
                        "description": "Scope is \"account\" or \"space\".",
                        "type": "string"
                    },
                    "spaceId": {
                        "description": "SpaceId binds a space-scoped collection; required iff scope is\n\"space\". Nothing drops the collection when the space goes away.",
                        "type": "string"
                    }
                },
                "type": "object"
            },
            "api.LocalCollectionInfo": {
                "properties": {
                    "count": {
                        "type": "integer"
                    },
                    "indexes": {
                        "items": {
                            "$ref": "#/components/schemas/api.LocalIndex"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
            ...
            "api.LocalDeleteResponse": {
                "properties": {
                    "deleted": {
                        "description": "Deleted counts documents actually removed (an id that was already\ngone is not counted, not an error).",
                        "type": "integer"
                    }
                },
                "type": "object"
            ...
            "api.LocalDocsRequest": {
                "properties": {
                    ...
                    "docs": {
                        "description": "Docs are JSON objects. A missing ` + "`" + `id` + "`" + ` is minted server-side\n(insert and upsert alike); it must be a string when present.",
                        "items": {
                            "additionalProperties": {},
                            "type": "object"
                        },
            ...
            "api.LocalEnsureRequest": {
                "properties": {
                    "indexes": {
                        "description": "Indexes to ensure on the collection (idempotent).",
                        "items": {
                            "$ref": "#/components/schemas/api.LocalIndex"
                        },
                        "type": "array",
            ...
            "api.LocalIndex": {
                "properties": {
                    "fields": {
                        "description": "Fields are field paths, \"-\" prefix for descending.",
                        "items": {
                            "type": "string"
                        },
                        "type": "array",
                    ...
                    "name": {
                        "description": "Name is derived from Fields when empty (e.g. \"kind,-at\").",
                        "type": "string"
                    },
                    "sparse": {
                        "type": "boolean"
            ...
            "api.LocalIndexesRequest": {
                "properties": {
                    "coll": {
                        "$ref": "#/components/schemas/api.LocalCollection"
                    },
                    "drop": {
                        "description": "Drop names indexes to remove (a missing name is not an error).",
                        "items": {
                            "type": "string"
                        },
                        "type": "array",
            ...
            "api.LocalQueryRequest": {
                "properties": {
                    ...
                    "limit": {
                        "description": "Limit defaults to 100, capped at 1000.",
                        "type": "integer"
                    },
                    "offset": {
                        "type": "integer"
            ...
            "api.LocalUpdateRequest": {
                "properties": {
                    ...
                    "modifier": {
                        "additionalProperties": {},
                        "description": "Modifier is a mongo-style modifier ($set / $unset / $inc / …).",
                        "type": "object"
                    },
                    "upsert": {
                        "description": "Upsert creates the document from the modifier when the id is\nabsent instead of answering 404 local.doc_not_found.",
                        "type": "boolean"
                    }
                },
                "type": "object"
            },
            "api.LocalUpdateResponse": {
                "properties": {
                    "modified": {
                        "description": "Modified reports whether the modifier changed the document.",
                        "type": "boolean"
                    },
                    "record": {
                        "additionalProperties": {},
            ...
            "api.MarkdownEditRequest": {
                "properties": {
                    "edits": {
                        "items": {
                            "$ref": "#/components/schemas/api.MarkdownEdit"
                        },
                        "type": "array",
                        "uniqueItems": false
                    }
            ...
            "api.PropertiesListResponse": {
                "properties": {
                    "properties": {
                        "items": {
                            "$ref": "#/components/schemas/api.PropertyDef"
                        },
                        "type": "array",
                        "uniqueItems": false
                    }
            ...
            "api.PropertyDef": {
                "properties": {
                    ...
                    "meta": {
                        ...
                        "description": "Meta is the consumer flag map (meta[\"index\"] for the search\nindexer).",
                        "type": "object"
                    },
                    "name": {
                        "type": "string"
            ...
            "api.PushSubscriptionsResponse": {
                "properties": {
                    "subscriptions": {
                        "items": {
                            "$ref": "#/components/schemas/api.PushSubscription"
                        },
                        "type": "array",
                        "uniqueItems": false
                    }
            ...
            "api.SpaceDebugResponse": {
                "properties": {
                    "peers": {
                        "items": {
                            "$ref": "#/components/schemas/api.PeerSyncStats"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
            ...
            "api.SpaceInfo": {
                "properties": {
                    ...
                    "push": {
                        "$ref": "#/components/schemas/api.SpacePushKeys"
                    },
                    "settings": {
                        "additionalProperties": {},
                        "type": "object"
            ...
            "api.SpaceModifyRequest": {
                "properties": {
                    ...
                    "records": {
                        "items": {
                            "$ref": "#/components/schemas/api.RecordModify"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
            ...
            "api.SpaceQueryRequest": {
                "properties": {
                    "dataset": {
                        "description": "Dataset names the per-object dataset (chat_messages,\neditor_blocks, …). Required.",
                        "type": "string"
                    },
                    "driftBudgetPercent": {
                        "description": "DriftBudgetPercent (subscribe only) bounds window drift before\nthe stream closes with reason \"drifted\". Default 30.",
                    ...
                    "objectId": {
                        "description": "ObjectId names the object whose dataset is queried. Required.",
                        "type": "string"
                    },
                    "offset": {
                        "description": "Offset skips past the first N matches of the sorted result.",
            ...
            "api.TypesListResponse": {
                "properties": {
                    "types": {
                        "items": {
                            "$ref": "#/components/schemas/api.TypeInfo"
                        },
                        "type": "array",
                        "uniqueItems": false
                    }
            ...
            "api.UpsertRequest": {
                "properties": {
                    ...
                    "pageSize": {
                        "description": "PageSize caps records per emitted change. 0 = 500.",
                        "type": "integer"
                    },
                    "records": {
                        "items": {
                            "$ref": "#/components/schemas/api.UpsertRecord"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
            ...
            "api.UpsertResult": {
                "properties": {
                    ...
                    "rejections": {
                        "items": {
                            "$ref": "#/components/schemas/api.UpsertRejection"
                        },
                        "type": "array",
                        "uniqueItems": false
                    },
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.AuthStatusResponse"
                                }
                            }
                        },
                        "description": "OK"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.DatasetsResponse"
                                }
                            }
                        },
                        "description": "OK"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.P2PStatusResponse"
                                }
                            }
                        },
                        "description": "OK"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.FileCacheInfo"
                                }
                            }
                        },
                        "description": "OK"
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.FileCacheFreeRequest",
                                        "summary": "body",
                                        "description": "Bytes to free"
                                    }
                                ]
                            }
                        }
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.FileCacheFreeResult"
                                }
                            }
                        },
                        "description": "OK"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.IdentitiesListResponse"
                                }
                            }
                        },
                        "description": "OK"
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.LocalAggregateRequest",
                                        "summary": "body",
                                        "description": "Collection + pipeline"
                                    }
                                ]
                            }
                        }
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.LocalAggregateResponse"
                                }
                            }
                        },
                        "description": "OK"
        ...
        "/local/collections": {
            "delete": {
                "parameters": [
                    ...
                    {
                        "description": "required for scope=space",
                        "in": "query",
                        "name": "spaceId",
                        "schema": {
                            "type": "string"
            ...
            "get": {
                "parameters": [
                    {
                        "description": "account | space (absent = both)",
                        "in": "query",
                        "name": "scope",
                        "schema": {
                            "type": "string"
                    ...
                    {
                        "description": "restrict to one space (scope=space)",
                        "in": "query",
                        "name": "spaceId",
                        "schema": {
                            "type": "string"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.LocalListResponse"
                                }
                            }
                        },
                        "description": "OK"
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.LocalEnsureRequest",
                                        "summary": "body",
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.LocalEnsureResponse"
                                }
                            }
                        },
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.LocalDeleteRequest",
                                        "summary": "body",
                                        "description": "Collection + ids | filter"
                                    }
                                ]
                            }
                        }
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.LocalDeleteResponse"
                                }
                            }
                        },
                        "description": "OK"
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.LocalGetRequest",
                                        "summary": "body",
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.LocalRecordResponse"
                                }
                            }
                        },
                        "description": "OK"
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.LocalIndexesRequest",
                                        "summary": "body",
                                        "description": "Collection + ensure/drop"
                                    }
                                ]
                            }
                        }
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.LocalIndexesResponse"
                                }
                            }
                        },
                        "description": "OK"
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.LocalDocsRequest",
                                        "summary": "body",
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.LocalIdsResponse"
                                }
                            }
                        },
                        "description": "OK"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.LocalMetaResponse"
                                }
                            }
                        },
                        "description": "OK"
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.LocalQueryRequest",
                                        "summary": "body",
                                        "description": "Collection + filter/sort/limit/offset"
                                    }
                                ]
                            }
                        }
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.LocalUpdateRequest",
                                        "summary": "body",
                                        "description": "Collection + id + modifier"
                                    }
                                ]
                            }
                        }
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.LocalUpdateResponse"
                                }
                            }
                        },
                        "description": "OK"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.PushSubscriptionsResponse"
                                }
                            }
                        },
                        "description": "OK"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.PushTokenStatus"
                                }
                            }
                        },
                        "description": "OK"
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.PushTokenSetRequest",
                                        "summary": "body",
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.SpaceListResponse"
                                }
                            }
                        },
                        "description": "OK"
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.SpaceCreateRequest",
                                        "summary": "body",
                                        "description": "Space params"
                                    }
                                ]
                            }
                        }
            ...
            "post": {
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.SpaceJoinRequest",
                                        "summary": "body",
                                        "description": "Invite token + optional metadata"
                                    }
                                ]
                            }
                        }
                ...
                "responses": {
                    "201": {
                        ...
                        "description": "Joined immediately"
                    },
                    "202": {
                        "content": {
                            "application/json": {
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.SpaceOneToOneRequest",
                                        "summary": "body",
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.SpaceRegisterIncomingRequest",
                                        "summary": "body",
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.SpaceListQueryRequest",
                                        "summary": "body",
                                        "description": "Query params (dataset defaults to spaces)"
                                    }
                                ]
                            }
                        }
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.SpaceUpdateRequest",
                                        "summary": "body",
                                        "description": "At least one field required"
                                    }
                                ]
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.ACLAcceptRequest",
                                        "summary": "body",
                                        "description": "Request record + permission"
                                    }
                                ]
                            }
                        }
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.ACLAddRequest",
                                        "summary": "body",
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.ACLDeclineRequest",
                                        "summary": "body",
                                        "description": "Identity to decline"
                                    }
                                ]
                            }
                        }
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.ACLOwnershipRequest",
                                        "summary": "body",
                                        "description": "New owner + old owner permission"
                                    }
                                ]
                            }
                        }
        ...
        "/spaces/{spaceId}/acl/permissions": {
            "post": {
                "parameters": [
                    {
                        "description": "Space ID",
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.ACLChangePermissionsRequest",
                                        "summary": "body",
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.ACLRemoveRequest",
                                        "summary": "body",
                                        "description": "Identities to remove"
                                    }
                                ]
                            }
                        }
        ...
        "/spaces/{spaceId}/acl/self-remove": {
            "post": {
                "parameters": [
                    {
                        "description": "Space ID",
        ...
        "/spaces/{spaceId}/acl/stop-sharing": {
            "post": {
                "parameters": [
                    {
                        "description": "Space ID",
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.SpaceAggregateRequest",
                                        "summary": "body",
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.SpaceDebugResponse"
                                }
                            }
                        },
                        "description": "OK"
        ...
        "/spaces/{spaceId}/debug/objects/{objectId}": {
            "get": {
                "parameters": [
                    {
                        "description": "Space ID",
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.ObjectDebugResponse"
                                }
                            }
                        },
                        "description": "OK"
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.DeleteRecordsRequest",
                                        "summary": "body",
        ...
        "/spaces/{spaceId}/files": {
            "get": {
                "parameters": [
                    ...
                    {
                        "description": "Restrict to one object's files",
                        "in": "query",
                        "name": "objectId",
                        "schema": {
                            "type": "string"
                    ...
                    {
                        "description": "Cap the result (0 = unlimited)",
                        "in": "query",
                        "name": "limit",
                        "schema": {
                            "type": "integer"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.FileListResponse"
                                }
                            }
                        },
                        "description": "OK"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.FileStats"
                                }
                            }
                        },
                        "description": "OK"
        ...
        "/spaces/{spaceId}/files/subscribe": {
            "get": {
                "parameters": [
                    {
                        "description": "Space ID",
        ...
        "/spaces/{spaceId}/files/{fileId}/content": {
            "get": {
                "parameters": [
                    ...
                    {
                        "description": "Variant tag (default: original)",
                        "in": "query",
                        "name": "variant",
                        "schema": {
                            "type": "string"
        ...
        "/spaces/{spaceId}/files/{fileId}/offload": {
            "post": {
                "parameters": [
                    {
                        "description": "Space ID",
        ...
        "/spaces/{spaceId}/files/{fileId}/pin": {
            "post": {
                "parameters": [
                    {
                        "description": "Space ID",
        ...
        "/spaces/{spaceId}/files/{fileId}/retry": {
            "post": {
                "parameters": [
                    {
                        "description": "Space ID",
        ...
        "/spaces/{spaceId}/files/{fileId}/status": {
            "get": {
                "parameters": [
                    {
                        "description": "Space ID",
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.FileStatus"
                                }
                            }
                        },
                        "description": "OK"
                ...
                "responses": {
                    "201": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.InviteCreateResponse"
                                }
                            }
                        },
                        "description": "Created"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.InvitesListResponse"
                                }
                            }
                        },
                        "description": "OK"
        ...
        "/spaces/{spaceId}/invites/{recordId}": {
            "delete": {
                "parameters": [
                    {
                        "description": "Space ID",
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.MembersListResponse"
                                }
                            }
                        },
                        "description": "OK"
        ...
        "/spaces/{spaceId}/members/requests": {
            "get": {
                "parameters": [
                    {
                        "description": "Space ID",
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.JoinRequestsResponse"
                                }
                            }
                        },
                        "description": "OK"
        ...
        "/spaces/{spaceId}/members/subscribe": {
            "get": {
                "parameters": [
                    {
                        "description": "Space ID",
        ...
        "/spaces/{spaceId}/members/{identity}": {
            "get": {
                "parameters": [
                    {
                        "description": "Space ID",
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.SpaceModifyRequest",
                                        "summary": "body",
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.ObjectCreateRequest",
                                        "summary": "body",
                ...
                "responses": {
                    "201": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.ObjectsCreateResponse"
                                }
                            }
                        },
                        "description": "Created"
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.SpaceAggregateObjectsRequest",
                                        "summary": "body",
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.BacklinksResponse"
                                }
                            }
                        },
                        "description": "OK"
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.ChatSendRequest",
                                        "summary": "body",
        ...
        "/spaces/{spaceId}/objects/{objectId}/chat/messages/{msgId}": {
            "delete": {
                "parameters": [
                    {
                        "description": "Space ID",
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.ChatEditRequest",
                                        "summary": "body",
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.BlockCreateRequest",
                                        "summary": "body",
                                        "description": "Block params (type required)"
                                    }
                                ]
                            }
                        }
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.BlockPatchRequest",
                                        "summary": "body",
                                        "description": "Set/unset ops"
                                    }
                                ]
                            }
                        }
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.MarkdownEditRequest",
                                        "summary": "body",
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.MarkdownSetResponse"
                                }
                            }
                        },
                        "description": "OK"
        ...
        "/spaces/{spaceId}/objects/{objectId}/files": {
            "post": {
                "parameters": [
                    {
                        "description": "Space ID",
                    ...
                    {
                        "description": "Variant tag (requires variantOf)",
                        "in": "query",
                        "name": "variant",
                        "schema": {
                            "type": "string"
                    ...
                    {
                        "description": "Original fileId this variant belongs to",
                        "in": "query",
                        "name": "variantOf",
                        "schema": {
                            "type": "string"
        ...
        "/spaces/{spaceId}/objects/{objectId}/files/query": {
            "post": {
                "parameters": [
                    {
                        "description": "Space ID",
        ...
        "/spaces/{spaceId}/objects/{objectId}/files/query/subscribe": {
            "post": {
                "parameters": [
                    {
                        "description": "Space ID",
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.HistoryListResponse"
                                }
                            }
                        },
                        "description": "OK"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.HistoryDiffResponse"
                                }
                            }
                        },
                        "description": "OK"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.HistoryViewResponse"
                                }
                            }
                        },
                        "description": "OK"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.HistoryRecordResponse"
                                }
                            }
                        },
                        "description": "OK"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.PropertiesGetResponse"
                                }
                            }
                        },
                        "description": "OK"
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.PropertiesSetRequest",
                                        "summary": "body",
                                        "description": "Patch map"
                                    }
                                ]
                            }
                        }
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.SpaceQueryRequest",
                                        "summary": "body",
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.SearchRequest",
                                        "summary": "body",
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.SpaceSettingsPatchRequest",
                                        "summary": "body",
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.SpaceSyncStatusResponse"
                                }
                            }
                        },
                        "description": "OK"
        ...
        "/spaces/{spaceId}/sync-status/objects/{objectId}": {
            "get": {
                "parameters": [
                    {
                        "description": "Space ID",
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.ObjectSyncStatusResponse"
                                }
                            }
                        },
                        "description": "OK"
        ...
        "/spaces/{spaceId}/sync-status/objects/{objectId}/subscribe": {
            "get": {
                "parameters": [
                    {
                        "description": "Space ID",
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.TypesListResponse"
                                }
                            }
                        },
                        "description": "OK"
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.TypesCreateRequest",
                                        "summary": "body",
                ...
                "responses": {
                    "201": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.TypesCreateResponse"
                                }
                            }
                        },
                        "description": "Created"
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.TypeDatasetsListResponse"
                                }
                            }
                        },
                        "description": "OK"
        ...
        "/spaces/{spaceId}/types/{typeId}/datasets/{defId}": {
            "delete": {
                "parameters": [
                    {
                        "description": "Space ID",
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.DatasetPatchRequest",
                                        "summary": "body",
        ...
        "/spaces/{spaceId}/types/{typeId}/datasets/{defId}/fields": {
            "post": {
                "parameters": [
                    {
                        "description": "Space ID",
                ...
                "responses": {
                    "201": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.AddDatasetFieldResponse"
                                }
                            }
                        },
                        "description": "Created"
        ...
        "/spaces/{spaceId}/types/{typeId}/datasets/{defId}/fields/{fieldId}": {
            "delete": {
                "parameters": [
                    {
                        "description": "Space ID",
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.DatasetFieldPatchRequest",
                                        "summary": "body",
                                        "description": "set/unset paths"
                                    }
                                ]
        ...
        "/spaces/{spaceId}/types/{typeId}/properties": {
            "get": {
                "parameters": [
                    {
                        "description": "Space ID",
                        ...
                        "application/json": {
                            "schema": {
                                "oneOf": [
                                    ...
                                    {
                                        "$ref": "#/components/schemas/api.UpsertRequest",
                                        "summary": "body",
                ...
                "responses": {
                    "200": {
                        "content": {
                            "application/json": {
                                "schema": {
                                    "$ref": "#/components/schemas/api.UpsertResult"
                                }
                            }
                        },
                        "description": "OK"
