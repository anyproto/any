...
//
// Lifecycle: meetingEnrich.propose drafts raw items; bao (the meeting-enrich
// skill) consolidates by editing/deleting records; the human reviews; the
// deterministic enrichApply program reads the items, applies them, and DELETES
