...
func TestExtractMentions(t *testing.T) {
	cases := []struct {
		...
		{"glued sentence period", "ping any://m/space1/ident1.Check this out", []string{"ident1"}},
		{"glued colon", "any://m/space1/ident1:said so", []string{"ident1"}},
		{"comma exclamation", "hey any://m/space1/ident1, really any://m/space1/ident2!", []string{"ident1", "ident2"}},
		{"dotted space id", "cc [x](any://m/bafyspace.1replkey/ident1)", []string{"ident1"}},
		{"dotted space id glued period", "cc any://m/bafyspace.1replkey/ident1.Next word", []string{"ident1"}},
