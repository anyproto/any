...
- **CLI ergonomics** — flag shapes, patch syntax, error messages; a handful of endpoints (space create/list, snapshot query, modify, delete-records) still need their `any` subcommand.
