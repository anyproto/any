...
<div class="cards">
<a href="accounts.html"><strong>Accounts</strong><span>Mnemonic ⇒ account id, `any init`, the `/v1/auth` flow, per-account data dirs.</span></a>
