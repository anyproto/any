...
| Method | Path | Body/params | Returns | Notes |
|---|---|---|---|---|
| POST | `…/objects/:objectId/files` | raw body; `Content-Type`; `?name&variant&variantOf` | 201 `FileInfo` | body-limit exempt; `400 file.variant_invalid`; deleted object `410 object.deleted` (before the body is read) |
