...
<a href="traces-and-replay.html"><strong>Traces and replay</strong><span>The JSONL record shapes, strict and loose replay, reading a run</span></a>
...
<a href="limits.html"><strong>Limits</strong><span>Fuel, wall time, memory, and what happens when a run hits them</span></a>
</div>
