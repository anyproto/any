...
export function TextCell({ value, placeholder, autoEdit, onCommit }: TextCellProps) {
  ...
  return (
    <button
      ...
      className={cn(
        'block h-full w-full truncate rounded-none px-3 py-1 text-left text-[14px]',
...
function CellInput({
  ...
  return (
    <Input
      ref={ref}
      className="h-full w-full rounded-none border-0 bg-foreground/[0.045] px-3 py-1 text-[14px] focus-visible:ring-1 focus-visible:ring-accent focus-visible:ring-inset focus-visible:ring-offset-0"
      value={value}
      placeholder={placeholder}
