...
PR-025 extends this surface from text typography into the surrounding
block editor chrome: side menu, slash menu, drag-handle menu, link
toolbar, and formatting toolbar. Keep typography decisions here and
interaction chrome decisions in `docs/specs/PR-025-anytype-editor-chrome.md`.
